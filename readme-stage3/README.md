...
4. All “ALLOWED” WAF requests and non-AWS service CloudTrail IP addresses are ran against their respective IP Insights endpoints to detect anomalous activity.
